...
class NecklaceTest {
    ...
    void testAddPreciousGem() {
        PreciousGem gem = new PreciousGem("Алмаз", 5.0, 15000, 90);
        necklace.addGem(gem);
    ...
    void testFindGemsByTransparency() {
        necklace.addGem(new PreciousGem("Алмаз", 5.0, 15000, 90));
    ...
    public void testSortGemsByValue() {
        ...
        necklace.addGem(new PreciousGem("Алмаз", 5.5, 15000, 90));  // Стоимость: 82500
        necklace.addGem(new SemiPreciousGem("Топаз", 2.5, 1200, 75)); // Стоимость: 3000
        necklace.addGem(new PreciousGem("Рубин", 2.0, 3000, 80));     // Стоимость: 6000
