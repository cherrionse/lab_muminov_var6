...
class VAr6Test {
    ...
    void testRemoveSymbol() {
        ...
        System.out.println("Результат даление символа из строк: " + String.join(", ", result));
    }
    ...
    void testInsertSymbolAtValidPosition() {
        ...
        System.out.println("Результат добавление символа в заданную позицию: " + String.join(", ", result));
    }
    ...
    void testInsertSymbolAtEnd() {
        ...
        System.out.println("Результат добавление символа в конец строки: " + String.join(", ", result));
    }
    ...
    void testInsertSymbolAtNegativePosition() {
        ...
        System.out.println("Результат некорректная позиция для вставк: " + String.join(", ", result));
    }
}
